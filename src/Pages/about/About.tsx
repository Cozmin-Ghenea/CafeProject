  ...
  return (
    <div className="container">
      ...
      <div className="descriptionSectionAboutUs">
        <h1>About Us</h1>
        <p className="smallDescriptionAboutUs">
      ...
      <div className="Ourheadquarters">
        ...
        <div className="container-wrapper">
          <div className="container">
            ...
            <h1 className="smallerTitle">United Kingdom</h1>
            <p>
              68 Asfordby Rd<br></br>
              Alcaston<br></br>
              SY6 1YA<br></br>
              +44 1241 918425
            </p>
          ...
          <div className="container">
            ...
            <h1 className="smallerTitle">Canada</h1>
            <p>
              1528 Eglinton Avenue<br></br>
              Toronto<br></br>
              Ontario M4P 1A6<br></br>
              +1 416 485 2997<br></br>
            </p>
          </div>
          <div className="container">
            <h1 className="bigTitle">
            ...
            <h1 className="smallerTitle">Australia</h1>
            <p>
              36 Swanston Street<br></br>
              Kewell<br></br>
              Victoria<br></br>
              +61 4 9928 3629<br></br>
            </p>
          </div>
        </div>
      </div>
